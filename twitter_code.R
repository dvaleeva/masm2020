...
# Twitter limit is 18,000 search results every 15 minutes, that's why we asked R to return no more that 10,000 tweets
...
# 1) Get the data about another hashtag and compare its sentiments with the sentiments of #herdimmunity hashtag
