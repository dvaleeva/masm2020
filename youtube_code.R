...
# 1. Analyze videos in Youtube channels
# 2. Ananlyze the text of Youtube video comments
...
# Module 3 – Video list: Here you can explore lists of videos in the channe
...
# If you need more information about Youtube Data Tools, you can refer to this materials:
# The blopost http://thepoliticsofsystems.net/2015/05/exploring-youtube/
# FAQ https://tools.digitalmethods.net/netvizz/youtube/faq.php
# Introdutory video: https://www.youtube.com/watch?v=sbErTW2MzCY
...
# In Youtube Data Tools, we will use the module 'Video List' to explore videos in the Youtube channel of Donald Trump.
...
# The page will load for some time and in the bottom of the page you will see the section 'Results'
...
# As we can see, there are currently 392 videos in Trump's channel
# Youtube Data Tools gives us various information about these videos: titles, number of likes and dislikes, number of comments and views, dates of pubslishing etc)
...
# Show the top 3 least popular videos, based on 
...
# For example, 'Video Info' module returns a comment network as a .gdf file.
...
## If you want to do more exercies, here are some ideas:
